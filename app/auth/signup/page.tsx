    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-6 bg-white">
      <div className="max-w-sm w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-500 text-sm">Verify your height once. Keep it forever.</p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 rounded-xl px-4 py-3 text-gray-700 font-medium text-sm hover:bg-gray-50 transition-colors disabled:opacity-60"
        >
